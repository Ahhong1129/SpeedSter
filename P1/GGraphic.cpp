...
//void GGraphic::update()
//{
//	if (GInput::getInstance()->isKeyDown(DIK_F) && d3dPP.Windowed == true)
//	{
//		d3dPP.Windowed = false;
//		GGraphic::getInstance()->d3dDevice->Reset(&d3dPP);
//	}
//	else if (GInput::getInstance()->isKeyDown(DIK_E) && d3dPP.Windowed == false) {
//
//		d3dPP.Windowed = true;
//		GGraphic::getInstance()->d3dDevice->Reset(&d3dPP);
//	}
